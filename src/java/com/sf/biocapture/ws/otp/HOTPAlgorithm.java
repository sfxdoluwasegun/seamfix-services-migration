 ...
 * 
 * web link : https://svn.forgerock.org/openam/tags/10.0.0-docs/products/amserver/source/com/sun/identity/authentication/modules/hotp/HOTPAlgorithm.java
 * more otp links : http://stackoverflow.com/questions/30953662/how-to-generate-otp-number-with-6-digits
 * 
 */
/**
...
//        // we are using the current timestamp as the moving factor towards ensuring that
//        // every new generated value is different from the previous.
//        long movingFactor = new Timestamp(new Date().getTime() ).getTime();
//        try {
//            System.out.println(HOTPAlgorithm.generateOTP(code, movingFactor, 6, false, 9));
//        } catch (Exception e) {
